...
public class SaveNowPlayingMoviesTest {

    private SaveNowPlayingMovies saveNowPlayingMovies;
    ...
    @Before
    public void setUp(){
        saveNowPlayingMovies = new SaveNowPlayingMovies(mockThreadExecutor, mockPostExecutionThread, mockNowPlayingMoviesRepository);
    }

    @Test
    public void testGetNowPlayingMoviesUseCaseObservable(){
        saveNowPlayingMovies.buildUseCaseObservable(mockPaginatedMovies);

        verify(mockNowPlayingMoviesRepository).saveNowPlayingMovies(mockPaginatedMovies);
    ...
    public void testShouldFailWhenNoOrEmptyParameters(){
        ...
        saveNowPlayingMovies.buildUseCaseObservable(null);
    }
